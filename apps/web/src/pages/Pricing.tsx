...
const plans = [
  {
    ...
    features: [
      ...
      "Injury risk alerts & auto-pause",
      "12 activities (drills, warm-ups, cool-downs)",
  ...
  },
  {
    ...
    features: [
      ...
      "Real-time pose tracking (33 landmarks)",
      "Injury risk alerts & auto-pause",
      "All 12 padel activities",
      "Full session history & review",
      "Recovery wizard (personalized cool-downs)",
      "Interactive body health map",
      "Health dashboard & readiness score",
