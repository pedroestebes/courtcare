...
export const stretchQuad: DrillDefinition = {
  ...
  difficulty: "beginner",
  description:
    "Static quad stretch following ACSM guidelines (15–30 second holds). Your quads absorb massive forces during split steps and directional changes. Maintains quadriceps and hip flexor flexibility to prevent tightness that contributes to patellar tendinopathy. Also serves as proprioceptive balance training (single-leg stance) — Rivera et al. 2017 found balance training reduces ankle sprains RR=0.57.",
  shortDescription: "ACSM stretch + balance training for knee protection.",
  instructions: [
    ...
    "Hold for 30 seconds per leg (ACSM guideline)",
    "Repeat 2 times per leg",
    "Challenge: try without wall support for added proprioceptive training",
  ],
  thumbnailEmoji: "🦿",
