...
export const warmupLunges: DrillDefinition = {
  ...
  difficulty: "beginner",
  description:
    "Neuromuscular activation lunges based on the FIFA 11+ warm-up program (Al Attar et al. 2017 — 30% injury reduction, BMC Sports Med). This functional movement mimics padel split-stance positions and activates quads, glutes, and hip flexors for explosive court coverage.",
  shortDescription: "FIFA 11+ neuromuscular activation for court movement.",
  instructions: [
    "Stand tall with feet together, hands on hips for balance",
    "Step forward into a controlled lunge — front knee over ankle, not past toes",
    "Lower back knee toward the ground — aim for 90° on both knees",
    "Keep your torso upright — engage your core throughout",
    "Push off front foot to return to start position",
    "Alternate legs — 10 lunges per side at controlled tempo",
    "Focus on knee alignment: avoid letting knee collapse inward (valgus)",
    "Total time: 90 seconds — part of your RAMP Activate phase",
  ],
  thumbnailEmoji: "🏃",
