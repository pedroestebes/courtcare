...
export const stretchHipFlexor: DrillDefinition = {
  ...
  difficulty: "beginner",
  description:
    "Deep stretch for your hip flexors and psoas — the muscles most shortened by court play and daily sitting. Tight hip flexors restrict your stride length, reduce power generation, and increase lower back stress. This stretch is non-negotiable after every session.",
  shortDescription: "Deep hip flexor release to prevent lower back strain.",
  instructions: [
    "Start in a half-kneeling position — one knee on the ground, other foot forward",
    "Keep your front knee at roughly 90 degrees, directly over your ankle",
    ...
    "Hold 30 seconds per side — breathe deeply into the stretch",
  ],
  thumbnailEmoji: "🧎",
