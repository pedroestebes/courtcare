...
export const stretchShoulder: DrillDefinition = {
  ...
  difficulty: "beginner",
  description:
    "Posterior shoulder stretch recommended by the Danish DSSF 2023 guidelines for overhead athletes. Targets posterior capsule tightness — a key contributor to shoulder impingement in racket sports (Bern Consensus 2022). The Thrower's Ten systematic review (PMC12633846) confirms this improves scapular control and ROM.",
  shortDescription: "DSSF-recommended posterior shoulder flexibility.",
  instructions: [
    ...
    "Keep the stretching arm straight — feel the stretch in the posterior shoulder",
    "Hold for 30 seconds per arm (ACSM guideline)",
    "Repeat 2 times per side",
    "Don't shrug your shoulders — keep them relaxed and down",
    "Focus on the back of the shoulder, not the deltoid",
  ],
  thumbnailEmoji: "🤸",
