...
export const stretchHamstring: DrillDefinition = {
  ...
  difficulty: "beginner",
  description:
    "Static hamstring stretch following ACSM guidelines (15–30 second holds, 2–4 reps per muscle group). Maintains flexibility and ROM after court play. Note: Afonso et al. 2021 (Frontiers in Physiology) found stretching alone doesn't reduce DOMS — combine with active cool-down (light jog) for best results.",
  shortDescription: "ACSM protocol — 30-second holds for flexibility maintenance.",
  instructions: [
    "Start with 2–3 minutes of light walking to begin your cool-down",
    "Stand tall, extend one leg forward with heel on the ground",
    "Keep the extended leg straight with toes pointing up",
    "Hinge at the hips — lean forward with a flat back, not rounded",
    "Reach toward your toes — feel the stretch behind the extended leg",
    "Hold for 30 seconds per side (ACSM recommended duration)",
    "Repeat 2 times per leg — breathe deeply to deepen the stretch",
    "Never bounce — static hold only for post-exercise stretching",
  ],
  thumbnailEmoji: "🧘",
